...
public class Main {
    ...
    public static class MyCustomErrorListener extends BaseErrorListener {
        ...
        public void syntaxError(Recognizer<?, ?> recognizer, Object offendingSymbol,
            ...
            String mensagemFinalLinha1 = primeiraLinhaErro;
            String mensagemFinalLinha2 = "Fim da compilacao";

            try {
                if (escritor != null) {
                    // Escreve no arquivo
                    escritor.write(mensagemFinalLinha1);
                    escritor.newLine();
                    escritor.write(mensagemFinalLinha2);
                    escritor.newLine();
                    escritor.flush(); // Garante que foi escrito imediatamente

                    // Também imprime no console
                    System.out.println(mensagemFinalLinha1);
                    System.out.println(mensagemFinalLinha2);
                } else {
